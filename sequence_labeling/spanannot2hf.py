'''
Functionality for converting the span annotation from custom format (spacy docs, lists of span tuples)
...
from data_tools.seqlab_data.create_spacy_span_dataset import get_doc_id
...
def extract_spans(docs, spans_list, downsample_empty=None, rnd_seed=42, verbose=False):
    ...
    '''
    data = { l: [] for l in LABEL_DEF.values() }
    for doc, spans in zip(docs, spans_list):
        ...
        label_to_spans = { l: [] for l in LABEL_DEF.values() }

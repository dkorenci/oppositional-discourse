...
class SklearnTransformerBase(metaclass=ABCMeta):
    def __init__(self, hf_model_label, lang:str, eval=0.1,
        ...
        '''
        print_gpu_utilization('model.init')
...
class SklearnTransformerClassif(SklearnTransformerBase):
    ...
    #todo separate methods for model and tokenizer init
    #todo handling of runtime execution params - batch size, device, ...
    ...
    def _init_model(self, num_classes):
        ...
        :return:
        '''
        # todo cleanup old tokenizer and model?
    ...
    def _init_classes(self, labels):
        ...
        # TODO: create integer labels, map to labels ?
